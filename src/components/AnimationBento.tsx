...
export const AnimationBento: React.FC = () => {
  return (
    <div
      id="bento-animation"
      className="bento-grey bento-area-anim relative p-6 sm:p-7 md:p-6 lg:p-8 flex flex-col justify-between overflow-hidden cursor-default select-none group h-full min-h-[260px] sm:min-h-0"
    >
